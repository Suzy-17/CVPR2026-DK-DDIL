...
class BaseLearner(object):
    def __init__(self, args):
        ...
        self.task_increments = args.get('increment_per_session', False)  # 安全获取配置参数
    ...
    def _evaluate(self, y_pred, y_true):
        ...
        if self.task_increments:
            grouped = accuracy(y_pred.T[0], y_true, self._known_classes, increment=self.task_increments, current_task=self._cur_task)
        else:
